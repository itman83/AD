...
<a href="javascript:(function(){window.open('http://v.t.sina.com.cn/share/share.php?appkey=3229244048&title='+encodeURIComponent(document.getElementById('aa').value)+'&url='+encodeURIComponent('')+'&source='+encodeURIComponent('')+'&sourceUrl='+encodeURIComponent(''),'_blank','width=450,height=400');})()" title="新浪微博">
<img alt="新浪微博" src="img/share/sina-weibo.png"></a> 
<h3>新浪微博</h3>
</div>
...
<a title="人人网" href="javascript:void((function(s,d,e){if(/xiaonei\.com/.test(document.getElementById('aa').value))return;
...
if(/Firefox/.test(navigator.userAgent))setTimeout(a,0);else%20a();})(screen,document,encodeURIComponent));" id="">
        <img alt="人人网" src="img/share/renren.png"></a>
        <h3>人人网</h3>
</div>
      
<!--kaixin-->
<div class="modal-button" id="modal-email-button">
<a title="开心网" href="javascript:d=document;t=d.selection?(d.selection.type!='None'?d.selection.createRange().text:''):(d.getSelection?d.getSelection():'');
void(kaixin=window.open('http://www.kaixin001.com/~repaste/repaste.php?&amp;rurl='+escape(document.getElementById('aa').value)+'&amp;rtitle='+escape('News Tilte')+'&amp;rcontent='+escape('News Tilte'),'kaixin'));kaixin.focus();" id="">
        <img alt="开心网" src="img/share/kaixin.png"></a>
        <h3>开心网</h3>
</div>
...
void(0);" title="腾讯微博"><img alt="腾讯微博" src="img/share/tencent-weibo.png"></a>
<h3>腾讯微博</h3>
</div>
...
<!--Dou Ban-->
<div class="modal-button" id="modal-rss-button">
<a title="豆瓣网" href="javascript:var u='http://www.douban.com/recommend/?url='+document.getElementById('aa').value+'&amp;title='+encodeURIComponent('News Tilte');window.open(u,'douban','toolbar=0,resizable=1,scrollbars=yes,status=1,width=450,height=330');void(0)" id="">
        <img alt="豆瓣网" src="img/share/douban.png"></a>
        <h3>豆瓣网</h3>
</div>
...
<!--qq Zone-->
<div class="modal-button" id="modal-rss-button">
<a title="QQ空间" href="javascript:(function(){window.open('http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url='+ encodeURIComponent(document.getElementById('aa').value)+ '&amp;title='+encodeURIComponent('News Tilte'),'_blank');})()" id="">
            <img alt="QQ空间" src="img/qq_zone.png"></a>
            <h3>QQ空间</h3>
</div>

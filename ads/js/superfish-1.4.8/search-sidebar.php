...
<form action="search.php" name="modifysearch" id="modifysearch" method="post" onSubmit="return valid_modify_search();">
          ...
          <div class="item-excerpt-inner"><h6 class="news-paper-name">Select Keyword</h6></div>
		  <div id="clearall" class="classifiedd-news-category2" style=" padding:0px">
           <div class="what-are-you-searching-side">
<input id="search-txt-side" class="what-are-you-searching-for-modify" type="text" onfocus="if (this.value == 'What are you searching for?') {this.value = ''; }" onblur="if (this.value == ''){this.value = 'What are you searching for?'; }" size="16" value="<?php echo $text ?>" name="search-txt">
</div>
		  ...
		  <figcaption> 
		  <div class="item-excerpt">
          <div class="item-excerpt-inner"><h6 class="news-paper-name">Select City</h6></div>
		  <div id="clearall" class="classifiedd-news-category2" style=" padding:0px">
		  ...
		  <figcaption> 
		  <div class="item-excerpt">
          <div class="item-excerpt-inner"><h6 class="news-paper-name">Select Newspaper</h6></div>
		  <div id="clearall" class="classifiedd-news-category2" style=" padding:0px">
          <div class="side-newspaper-search">
          <div id="showHidecity1-search">
           <ul>
...
//		echo "<pre>";	print_r($atul);
		//	die;  
		  ...
		  <figcaption> 
		  <div class="item-excerpt">
		  <div id="clearall" class="classifiedd-news-category2 alignright" style="padding:0px"><input type="submit" class="search-btn" value="Modify Search" name="modifysearch" /></div></div>
          </figcaption> 
		  </figure> 
		  </div><!-- ENDS Filter Listing -->
          </form>
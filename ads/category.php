...
<section>
	...
	<div class="wrapper" onclick="closehead();"> 
        ...
        <div class="item-excerpt-inner"><h6 class="news-paper-name">选择類別</h6></div>
  ...
  <?php	$query_new = mysql_fetch_array(mysql_query("SELECT * FROM newspapers WHERE id = (SELECT newspaper_id FROM category_to_newspaper WHERE id = '".base64_decode($_GET['id'])."')")); ?>
          <ul>
          <li><input  onClick="check_all_cat(this);" type="checkbox" value="">选择全部</li>
		  ...
		  <figcaption>
		  <div class="item-excerpt">
          <div class="item-excerpt-inner"><h6 class="news-paper-name">广告列表</h6></div>

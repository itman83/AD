...
<?php include 'header.php' ?>
	<div class="wrapper1" onClick="closehead();">
    	<!--- start fa-classified ---->
			...
			<h4 class="fa">首页 &raquo; <?php echo $query['newspaper_name']?></h4>
            </div>
       </div>
<!--- start section ---->
<section>
	...
	<div class="wrapper" onclick="closehead();">
        ...
        <div id="portfolio-content" class="cf">        	
         <div id="filter-container-category" class="cf" onClick="closeall();">
          ...
          <?php $query=	 mysql_fetch_array(mysql_query("SELECT * FROM newspapers WHERE  id = '".base64_decode($_GET['id'])."' AND status=1")); 
          //$query = mysql_fetch_array(mysql_query("SELECT * FROM newspapers WHERE id = (SELECT newspaper_id FROM category_to_newspaper WHERE id = '".base64_decode($_GET['id'])."') AND status=1")); ?>
          <ul>
          <li><input  onClick="check_all_cat(this);" type="checkbox" checked value="">选择全部</li>

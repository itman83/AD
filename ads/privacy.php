						...
						<figcaption>
                          ...
                          <div class="item-excerpt">
                          	<div class="item-excerpt-inner">
                               ...
                               <?php
				 $menu_name = mysql_fetch_array(mysql_query("SELECT * FROM menu WHERE id = 10 "));
				?>
							...
							<div id="Accordion1" class="Accordion" tabindex="0">
                             <?php 
				$content = mysql_query("SELECT * FROM pages WHERE menu_id = (SELECT id FROM menu WHERE id = 10 )");	
